        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn bg-gradient-info btn-sm" onclick="location.href='{{ route('admin.data_kandidat_create') }}'"><i class="fa-sm fas fa-plus"></i> Tambah Data</button>
                </div>
                <div class="card-body">
